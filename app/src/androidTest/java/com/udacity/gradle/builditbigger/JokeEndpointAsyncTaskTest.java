...
public class JokeEndpointAsyncTaskTest {
    ...
    @Test
    public void jokeEndpointAsyncTaskTest() {
        ...
        //
        ViewInteraction jokeSetupText = onView(
                allOf(withId(R.id.joke_setup_text),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction jokePunchlineText = onView(
                allOf(withId(R.id.joke_punchline_text),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        jokePunchlineText.check(matches(not(withText(""))));
